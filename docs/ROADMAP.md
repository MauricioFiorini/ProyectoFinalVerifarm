...
identificadores no se reciclan ni se renumeran: la 1.11 ya está referenciada en
la documentación y en el historial. El orden de ejecución lo manda la columna
"Depende", y la 1.11 depende de la 1.12. La prueba de humo se corre **recién
...
prueba tendría que estar verificando.
