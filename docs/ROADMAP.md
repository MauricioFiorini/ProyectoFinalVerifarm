...
|---|---|---|---|---|---|
| 1.14 | Juan Pablo | `fix/1.14-lock-y-procedimiento-de-dependencias` | activa | Terminada, en revisión de Mauricio. Se cierra al mergear el PR. | 2026-09-01 |
| 1.15 | Juan Pablo | `docs/1.15-driver-adapter-y-comentario-de-db` | activa | — | 2026-09-01 |
